...
program
    ...
    try {
        const options = {
            ...
            preferVersion: commandOptions.protocolVersion !== undefined
                ? parseProtocolVersion(commandOptions.protocolVersion)
                : undefined,
            env: parseEnvEntries(commandOptions.env ?? []),
            maxSchemaBytes: commandOptions.maxSchemaSize !== undefined
                ? Number.parseInt(commandOptions.maxSchemaSize, 10) || undefined
                : undefined,
            maxLineBytes: commandOptions.maxLineSize !== undefined
...
program
    ...
    try {
        const options = {
            ...
            era: parseEra(commandOptions.era ?? 'legacy'),
            version: commandOptions.protocolVersion !== undefined
                ? parseProtocolVersion(commandOptions.protocolVersion)
                : undefined,
        };
