...
export function parseHttpTransport(value: string): HttpTransportKind {
...
export function parseHttpAccept(value: string | undefined): 'json' | 'sse' | undefined {
